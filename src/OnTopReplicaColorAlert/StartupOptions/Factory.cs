    ...
    class Factory {
        ...
        private static void ParseCommandLine(string[] args, Options options) {
            var cmdOptions = new NDesk.Options.OptionSet()
                ...
                .Add<Size>("position=", "Target {X,Y} of the OnTopReplicaColorAlert window.", s => {
            ...
            try {
                ...
                options.DebugMessageWriter.WriteLine("Try 'OnTopReplicaColorAlert /help' for more information.");
