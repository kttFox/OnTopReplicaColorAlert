...
using System.Text;
using OnTopReplicaColorAlert.Platforms;
...
namespace OnTopReplicaColorAlert {
    ...
    abstract class PlatformSupport {
        ...
        /// <summary>
        /// Checks whether OnTopReplicaColorAlert is compatible with the platform.
        /// </summary>
        /// <returns>Returns false if OnTopReplicaColorAlert cannot run and should terminate right away.</returns>
